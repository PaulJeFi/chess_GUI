settings = {
    ...
    "strength" : { # The level of the engine
        ...
        "ELO" : False, # Use ELO limit strenght. Only for Stockfish.
                       ...
                       # type False.
        "drawer" : False # True if you want the engine plays at your playing
                         # level. Reset all previous strength settings if True.
                         # True or False
    },
    "use openning book" : True, # If you want to use the strong book avialable
                                # from [url]. True or False.
    "use endgame tablebase" : True, # If you want to use Sgygi endgame tablebase
